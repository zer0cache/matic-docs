...
Please, check [the latest matic.js Documentation of Plasma ERC721](https://maticnetwork.github.io/matic.js/docs/plasma/erc721/) to get started and see all up-to-date methods.
