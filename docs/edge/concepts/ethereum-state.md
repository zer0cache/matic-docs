...
description: Explanations for Merkle trees and Ethereum state.
keywords:
  - docs
  - polygon
  - edge
...
![Example Merkle tree](/img/edge/state/merkleTree.png)
...
![World State](/img/edge/state/worldState.png)
...
![Account State](/img/edge/state/accountState.png)
...
![Block Structure](/img/edge/state/block.png)
...
![Main Diagram](/img/edge/state/mainDiagram.png)
