...
* [Who is a Validator](../polygon-basics/who-is-validator)
* [Who is a Delegator](../polygon-basics/who-is-delegator)

## Architecture

If your goal is to become a validator, it is essential that you understand the Polygon architecture.

See [Polygon Architecture](../validator/architecture) for more information.
...
* [Run a Validator Node with Ansible](../validate/run-validator-ansible)
* [Run a Validator Node from Binaries](../validate/run-validator-binaries)

### Staking operations

Check how the staking process is carried out for the validator and delegator profiles:

* [Validator Staking Operations](../validate/validator-staking-operations)
