...
id: economics
title: Economics
description: Learn the economics of the Polygon Network.
keywords:
  - docs
  - matic
  - polygon
...
Stakers running validator nodes and stakers delegating their tokens toward a [validator](/docs/validate/glossary#validator) that they prefer.

Validators have the option to charge a commission on the reward earned by [delegators](/docs/validate/glossary#delegator).
...
Setting up a validator node is a job that comes with responsibilities.

See [Validator Responsibilities](/docs/validate/validate/validator-responsibilities).
...
To be a [validator](/docs/validate/glossary#validator), you need to run a full validator node and stake MATIC.

See [Validate](/docs/validate/validate/getting-started).

## Becoming a delegator

To be a [delegator](/docs/validate/glossary#delegator), you only need to delegate MATIC to a validator.

See [Delegate](/docs/validate/delegate).
