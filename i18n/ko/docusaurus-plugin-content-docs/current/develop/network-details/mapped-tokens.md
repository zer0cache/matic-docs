...
토큰을 매핑하려면 https://mapper.polygon.technology/를 통해 매핑 요청을 보내십시오.

아래 표는 다음을 포함하되 이에 국한되지 않는 뭄바이 테스트넷의 다른 매핑된 토큰에 대한 몇 가지 예를 보여줍니다:


| 토큰명        | 브리지 | 상위 체인 주소: Goerli                                                                                                 | 하위체인: MUMBAI                                                                                                                  |
| ----------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
토큰을 매핑하려면 https://mapper.polygon.technology/를 통해 매핑요청을 보내십시오.

아래 표는 다음을 포함하되 이에 국한되지 않는 폴리곤 메인넷의 다른 매핑된 토큰에 대한 몇 가지 예를 보여줍니다:

| 토큰명       | 브리지 | 상위 체인 주소: 이더리움 메인넷                                                                                | 하위 체인: 폴리곤 네트워크                                                                                                      |
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
