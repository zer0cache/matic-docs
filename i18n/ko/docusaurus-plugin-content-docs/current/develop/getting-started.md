...
해커톤은 전 세계의 블록체인 컨퍼런스와 밋업에서 열립니다. 순식간에 비행기를 탈 수는 없지만 일부 회의나 프로젝트에서는 인터넷에 연결된 모든 사람이 참여할 수 있는 가상 해커톤을 주최합니다. [폴리곤의 해커톤 디스코드 채널](https://discord.gg/polygon) 확인하기
